...
---
{
	date: vars.date,
	sdlcMetrics: {
		bitBucketMetrics: if(p('sdlc.bitbucket.enabled') == "true") {
			totalRepositories: bitbucketData.size default null
		} else {
		},
		confluenceMetrics: if(p('sdlc.confluence.enabled') == "true") {
		...
		jenkinsMetrics: if(p('sdlc.jenkins.enabled') == "true") {
		...
		jiraMetrics: if(p('sdlc.jira.enabled') == "true") {
		...
		splunkMetrics: if(p('sdlc.splunk.enabled') == "true") {
